...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) {
        ...
        createBrand($connection, $data);

        $_SESSION['success'] = 'Create new brand <b>' . $name . '</b> successfully';
                                ...
                                <form id="edit-profile" class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                                    <fieldset>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="span4" id="link" name="link" value="<?php echo !empty($link) ? $link : ''; ?>">
                                            </div> <!-- /controls -->
                                        </div> <!-- /control-group -->
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select name="active" class="span4">
                                                    ...
                                                    <option <?php echo (!empty($activeBrand) && $activeBrand == '1') ? 'selected=\"selected\"' : '';  ?> value="1" class="text-center">ACTIVE</option>
                                                </select>
                                            </div> <!-- /controls -->
                                        </div> <!-- /control-group -->
